<?php
	function printTitle() {
		...
		print "<h2 onClick=\"window.print();\">Отчет о состоянии текущих задач</h2>\n";
	...
	function printHeader() {
		...
		print "<tr>\n";
		print "<th class=\"report\" width=\"33%\" colspan=\"6\">Инициатор</th>\n";
		print "<th class=\"report\" width=\"33%\" colspan=\"6\">Получатель</th>\n";
		print "<th class=\"report\" width=\"33%\" colspan=\"7\">Исполнитель</th>\n";
		print "</tr>\n";
		print "<tr>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">Предприятие</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">ФИО</th>\n";
		print "<th class=\"report\" width=\"auto\" colspan=\"2\">Документ-основание</th>\n";
		print "<th class=\"report\" width=\"auto\" colspan=\"2\">Задача</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">Дата и время доставки</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">Служба</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">ФИО</th>\n";
		print "<th class=\"report\" width=\"auto\" colspan=\"3\">Класс задачи</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">Должность</th>\n";
		print "<th class=\"report\" width=\"auto\" rowspan=\"2\">ФИО</th>\n";
		print "<th class=\"report\" width=\"auto\" colspan=\"5\">Текущее состояние задачи</th>\n";
		print "</tr>\n";
		print "<tr>\n";
		print "<th class=\"report\" width=\"auto\">№</th>\n";
		print "<th class=\"report\" width=\"auto\">Дата и время</th>\n";
		print "<th class=\"report\" width=\"auto\">Тема</th>\n";
		print "<th class=\"report\" width=\"auto\">Выполнить до</th>\n";
		print "<th class=\"report\" width=\"auto\">Важность</th>\n";
		print "<th class=\"report\" width=\"auto\">Вес (часов)</th>\n";
		print "<th class=\"report\" width=\"auto\">Выполнить до</th>\n";
		print "<th class=\"report\" width=\"auto\">Статус</th>\n";
		print "<th class=\"report\" width=\"auto\">Коментарий исполнителя</th>\n";
		print "<th class=\"report\" width=\"auto\">Фактические трудозатраты</th>\n";
		print "<th class=\"report\" width=\"auto\">Выполнено %</th>\n";
		print "<th class=\"report\" width=\"auto\">Оценка работы</th>\n";
		print "</tr>\n";
		print "<tr>\n";
		print "<th class=\"noborders\" width=\"auto\" colspan=\"19\">&nbsp;</th>\n";
		print "</tr>\n";
	}
	...
	function printBody($process, $group_by) {
		...
		print $process['id'];
		print "</a></td>\n";
		print "<td class=\"report\">".getPropertyValueByName($properties, 'Дата и время получения Инициатором')."</td>";
		print "<td class=\"report\">".getPropertyValueByName($properties, 'Текст')."</td>\n";
		print "<td class=\"report\">".getPropertyValueByName($properties, 'Желаемый срок исполнения')."</td>\n";
		...
		print "</td>\n";
		$reciever = $engine->getConnection()->execute('select * from accounts_tree where name = \''.getPropertyValueByName($properties, 'Получатель').'\'')->fetch();
		print "<td class=\"report center\">".$reciever['divisionname']."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Получатель')."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Приоритет')."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Планируемые трудозатраты')."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Срок исполнения').(getPropertyValueByName($properties, 'Срок исполнения')?" ".END_WORK_TIME:"")."</td>\n";

		$executor = $engine->getConnection()->execute('select * from accounts_tree where name = \''.getPropertyValueByName($properties, 'Исполнитель').'\'')->fetch();
		print "<td class=\"report center\">".$executor['description']."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Исполнитель')."</td>\n";
		print "<td class=\"report\">".$process['statusname']."</td>";
		print "<td class=\"report\">".getPropertyValueByName($properties, 'Комментарий Исполнителя')."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Фактические трудозатраты')."</td>\n";
		print "<td class=\"report center\">".getPropertyValueByName($properties, 'Процент выполнения')."</td>\n";
