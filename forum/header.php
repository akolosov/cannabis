...
$tpl_main = str_replace('<pun_title>', '
		<ul class="conl">
			<li><h1><span>'.pun_htmlspecialchars($pun_config['o_board_title']).'</span></h1></li>
			<li><p><span>'.$pun_config['o_board_desc'].'</span></p></li>
		</ul>
		<ul class="conr">
			<li><h1><span><a href="'.($_SERVER['HTTPS']?"https://":"http://").$_SERVER['SERVER_NAME'].'/" ></a></span></h1></li>
		</ul>
		<div class="clearer"></div>', $tpl_main);
// END SUBST - <pun_title>
...
// START SUBST - <pun_link>
//$tpl_main = str_replace('<pun_link>', '<h1><span><a href="'.($_SERVER['HTTPS']?"https://":"http://").$_SERVER['SERVER_NAME'].'/" ></a></span></h1>', $tpl_main);
// END SUBST - <pun_link>
