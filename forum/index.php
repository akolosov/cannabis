...
if ($pun_user['g_read_board'] == '0') {
	$URL = ($_SERVER['HTTPS']?"https://":"http://").$_SERVER['SERVER_NAME']."/forum/login.php?action=in";
	header ("Location: $URL");
...
<?php
	...
	if ($cur_forum['last_post'] != '')
		$last_post = '<a href="viewtopic.php?pid='.$cur_forum['last_post_id'].'#p'.$cur_forum['last_post_id'].'">'.format_time($cur_forum['last_post']).'</a> <span class="byuser"><span style="color:#666;">'.$lang_common['by'].'</span> '.pun_htmlspecialchars($cur_forum['last_poster']).'</span>';
	else
		$last_post = '&nbsp;';
