...
if (isset($_POST['form_sent']))
{
	...
	if (empty($errors) && !isset($_POST['preview']))
	{
			...
			if (($file_error == "0") and (is_uploaded_file($_FILES["filename"]["tmp_name"]))) {
		...
		redirect('viewtopic.php?pid='.$new_pid.'#p'.$new_pid, $lang_post['Post redirect'], $db->prefix, $_FILES["filename"]["name"], $new_pid);
	}
}
				...
				<fieldset>
					...
					<div class="infldset">
						<div class="rbox">
							...
							<br>Прикрепить файл: <input type="file" name="filename"><br>						
						</div>
					</div>
				</fieldset>
<?php
